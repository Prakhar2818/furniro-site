...
export const TEAM_IMAGES = [
  "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=300&h=300&q=80", // Professional businessman
  "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&h=300&q=80", // Female designer
  "https://images.unsplash.com/photo-1582750433449-648ed127bb54?auto=format&fit=crop&w=300&h=300&q=80", // Male craftsman
  "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=300&h=300&q=80", // Female executive
] as const;

// About page content images
export const ABOUT_IMAGES = [
  "https://images.unsplash.com/photo-1581539250439-c96689b516dd?auto=format&fit=crop&w=600&h=400&q=80", // Modern furniture workshop
  "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=600&h=400&q=80", // Elegant showroom
  "https://images.unsplash.com/photo-1540932239986-30128078f3c5?auto=format&fit=crop&w=600&h=400&q=80", // Craftsmanship details
] as const;
